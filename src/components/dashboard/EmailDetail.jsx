...
const EmailDetail = ({ thread, onSendReply, onMarkAsUnread }) => {
  ...
  const handleSendReply = async (data) => {
    if (replyingToIndex === null) return;

    // const replyingToMessage = messages[replyingToIndex];
                  ...
                  <div className="border-b border-gray-200 py-4 hover:bg-gray-50 transition-colors">
                    ...
                    {isExpanded && (
                      <div className="ml-14 mt-4">
                        ...
                        {/* Last message: always show buttons when expanded */}
                        {/* Other messages: show only when expanded and not currently replying to this message */}
